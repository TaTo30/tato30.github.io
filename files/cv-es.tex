  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Diseñé y desarrollé una plataforma de firma digital con certificados digitales, certificados de un solo uso y sellos digitales, integrando múltiples proveedores de identidad vía APIs REST; construida con Vue 2/3, Python, Odoo y PostgreSQL, contenerizada con Docker y desplegada en Kubernetes sobre AWS y posteriormente en Oracle Cloud, para más de 12 entidades financieras y gubernamentales de Centroamérica.}
        \resumeItem{Migré un frontend de administración de documentos de Vue 2 a Vue 3, Mejorando el codebase al migrar los reescribir los componentes de Vue utilizando Composition API.}
